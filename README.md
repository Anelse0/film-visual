...
独立的影视视觉开发 Skill，当前版本 **1.2.0**。直接处理视觉方案、场景与人物/服饰/道具设计、图像提示词、参考编辑指令和图片审阅、视频画面基调，以及已有 prompt 的授权视觉段修订。
...
下载 [独立安装包](dist/film-visual-1.2.0.zip)，解压后进入其中的 `film-visual/`：
